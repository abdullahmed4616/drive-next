...
export default function HomePage() {
    ...
    return (
        <div className="flex flex-col">
            ...
            <section className="relative overflow-hidden pt-20 pb-28 lg:pt-32 lg:pb-40">
                ...
                <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-3xl text-center">
                        <div className="inline-flex items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.03] px-4 py-1.5 text-sm font-medium text-white/60 mb-8 backdrop-blur-sm">
                        ...
                        <p className="mx-auto mb-10 max-w-xl text-lg text-white/45 leading-relaxed">
                        ...
                        {/* AI Search Bar - Primary Interaction Point */}
                    ...
                    <div className="relative mx-auto mt-20 max-w-4xl">
                        ...
                        <div className="relative rounded-2xl border border-white/[0.06] bg-card/80 p-3 shadow-2xl backdrop-blur-sm">
                            {/* Browser chrome */}
                            ...
                            <div className="grid gap-3 md:grid-cols-3">
                                {[
                                    ...
                                    <div key={drive.name} className="rounded-xl bg-white/[0.02] border border-white/[0.05] p-4 hover:bg-white/[0.04] transition-colors">
                                        <div className="mb-3 flex items-center gap-2.5">
                                            <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${drive.color} flex items-center justify-center`}>
            ...
            {/* Stats Section */}
            <section className="py-16 lg:py-20 border-y border-white/[0.05]">
                <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
                        {stats.map((stat) => (
                            <div key={stat.label} className="text-center">
                                ...
                                <div className="mt-1.5 text-sm text-white/35">{stat.label}</div>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                        {features.map((feature) => (
                            <div
                                key={feature.title}
                                className="group rounded-2xl border border-white/[0.05] bg-white/[0.02] p-6 hover:bg-white/[0.04] hover:border-white/[0.08] transition-all duration-300"
                            >
                        ...
                        {steps.map((step, index) => (
                            <div key={step.number} className="relative">
                                {index < steps.length - 1 && (
                                    <div className="absolute left-full top-12 hidden h-px w-full bg-gradient-to-r from-white/[0.06] to-transparent md:block" style={{ width: 'calc(100% - 2rem)' }} />
                                )}
                                <div className="relative rounded-2xl border border-white/[0.05] bg-white/[0.02] p-6 hover:bg-white/[0.04] transition-colors">
                                    <div className="mb-3 text-5xl font-extrabold bg-gradient-to-b from-white/8 to-transparent bg-clip-text text-transparent">
                                        {step.number}
                                    </div>
                ...
                <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                        {testimonials.map((testimonial) => (
                            <div key={testimonial.author} className="rounded-2xl border border-white/[0.05] bg-white/[0.02] p-6 hover:bg-white/[0.03] transition-colors">
                                ...
                                <div className="flex items-center gap-3 pt-4 border-t border-white/[0.05]">
                                    <div className="h-9 w-9 rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center text-primary text-xs font-bold">
            ...
            <section className="relative overflow-hidden py-20 lg:py-24">
                ...
                <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center rounded-3xl border border-white/[0.06] bg-white/[0.02] p-12 backdrop-blur-sm">
                        <h2 className="mb-4 text-3xl font-extrabold text-white md:text-4xl tracking-tight">
                            Ready to simplify your cloud storage?
                        </h2>
                        <p className="mx-auto mb-8 max-w-lg text-lg text-white/40">
